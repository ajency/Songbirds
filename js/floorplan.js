...
//functions to open interactive tour in pop-up
	function showIntTour(houseNo, houseType){
		window.open ("aquila_floor_i.html?houseNo="+houseNo+"&houseType="+houseType, "mywindow","status=1,toolbar=1");
	}
	function showIntTour1(){
		window.open ("aquila_floor_i.html", "mywindow1","status=1,toolbar=1");
	}
	...
	function writeFlash() {
		...
		var width = '900'
		var height = '600'
		var src = 'interactive-tools/aquila-intractive/aquila.swf'
		// queries -- type in the variables you want to send to flash here
		var queries = '?houseNo='+QueryString('houseNo')+'&houseType='+QueryString('houseType')
		// assemble flash obj
		/*
